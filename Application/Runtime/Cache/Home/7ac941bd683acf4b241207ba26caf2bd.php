                        ...
                        <tbody><tr>
                           ...
                           <?php foreach ($cartInfo as $k => $v): ?>
                            ...
                            <tr>
                                ...
                                <td><?php echo $v['gastr'];?><br />
                                </td>
                                <td align="right">￥<?php echo $v['info']['market_price'] ;?>元</td>
                                <td align="right">￥<?php echo $v['info']['shop_price'];?>元</td>
                                <td align="right">
                                    <input name="goods_number[43]" id="goods_number_43" value="<?php echo $v['goods_number'];?>" size="4" class="inputBg" style="text-align: center;" onkeydown="showdiv(this)" type="text" />
                                </td>
