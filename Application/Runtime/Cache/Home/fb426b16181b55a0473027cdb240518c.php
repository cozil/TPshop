    ...
    <body class="index_body">
        ...
        <div id="mainNav" class="clearfix">
                ...
                <?php foreach ($cate as $k => $v): ?>
                    ...
                    <a href="<?php echo U('Category/lst', array('cate_id'=>$v['id']));?>"><?php echo $v['cat_name'];?><span></span></a>
            ...
            <div class="AreaL">
               <h3><span>商品分类</span></h3> 
                <div id="category_tree" class="box_1">
                    <?php foreach ($cateTree as $k => $v){ ?>
                        <?php if($v['parent_id'] == 0){?>
                                        
                                    <dl>
                                        <dt><a href="<?php echo U('Category/lst', array('cate_id'=>$v['id']), false);?>"><?php echo $v['cat_name'];?></a></dt>
                                        <dd>     
                                        <?php foreach ($cateTree as $k1 => $v1){?>
                                                <?php if($v1['parent_id'] == $v['id']){?>
                                            <a href="<?php echo U('Category/lst', array('cate_id'=>$v1['id']), false);?>"><?php echo $v1['cat_name'];?></a>
