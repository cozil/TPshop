...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body class="index_body">
        ...
        <div class="block">
            ...
            <form action="<?php echo U('Cart/order2');?>" method="POST" name="theForm" id="theForm"  enctype="multipart/form-data">
                <div class="flowBox">
                        ...
                        <tbody><tr>
                            ...
                            <?php $tp = 0; foreach ($cartData as $k => $v): ?>
                                <tr>
                                    ...
                                    <td align="right">￥<?php echo $v['info']['goods_price'];?>元</td>
                                    <td align="right"><?php echo $v['goods_number'];?></td>
                                    <td align="right">￥<?php echo $v['info']['goods_price'] * $v['goods_number']; $tp += $v['info']['goods_price'] * $v['goods_number'];?>元</td>
                                </tr>
                            <?php endforeach ?>
                    ...
                    <table cellpadding="5" cellspacing="1" width="99%">
                        <tbody><tr>
                            ...
                            <tr>
                                ...
                                <td>邮政编码:</td>
                                <td><input type="text" name="zcode" id=""></td>
                            </tr>
                            <tr>
                                <td>电话:</td>
                                <td><input type="text" name="iphone" id=""> </td>
                                <td>手机:</td>
                                <td>13522734035</td>
                            </tr>
                            <tr>
                ...
                <div class="flowBox">
                    ...
                    <div id="ECS_ORDERTOTAL">
                        <table cellpadding="5" cellspacing="1" width="99%">
                            <tbody>
                                <tr>
                                    <td align="right"> 应付款金额: <font class="f4_b">￥<?php echo $tp;?>元</font>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                    ...
                    <div style="margin: 8px auto; position:relative;">
                        <input  type="submit" style="float: right; padding: 14px;" />
                    </div>
                </div>
            </form>
        </div>
