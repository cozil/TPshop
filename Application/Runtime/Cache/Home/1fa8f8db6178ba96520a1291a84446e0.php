        ...
        <div class="block clearfix">
            ...
            <div class="AreaR">
                ...
                <div id="show_best_area" class="clearfix">
                     <?php foreach ($isBest as $k => $v): ?>
                    
                    <div class="goodsItem">
                        <a href="<?php echo U('det', array('id'=>$v['id']), false);?>"><img src="<?php echo $viewPath . $v['img_sam'];?>" alt="<?php echo $v['goods_name'];?>" class="goodsimg"></a><br />
                        <p class="f1"><a href="<?php echo U('det', array('id'=>$v['id']), false);?>" title="<?php echo $v['goods_name'];?>"><?php echo $v['goods_name'];?></a></p>
                ...
                <div class="box">
                    <div class="box_1">
                        <h3>
                            <span>商品列表</span>
                            <form method="GET" class="sort" name="`">
                                显示方式：
                        ...
                        <form name="compareForm" action="compare.php" method="post" onsubmit="return compareGoods(this);">
                            <div class="clearfix goodsBox" style="border: medium none; padding: 11px 0pt 10px 5px;">
                                ...
                                <?php foreach ($goodsData as $k => $v): ?>
                                    ...
                                    <div class="goodsItem">
                                        <a href="<?php echo U('det', array('id'=>$v['id']), false);?>"><img src="<?php echo $viewPath . $v['img_sam'];?>" alt="诺基亚N85" class="goodsimg"></a><br />
                                        <p><a href="<?php echo U('det', array('id'=>$v['id']), false);?>" title="诺基亚N85"><?php echo $v['goods_name'];?></a></p>
                                        <font class="market_s">￥<?php echo $v['market_price'];?>元</font><br />
