...
<span class="action-span1">
    <a href="">管理中心</a>
    </span><span id="/search_id" class="action-span1">- 添加商品新类型</span>
...
<div class="tab-div">
    ...
    <div id="tabbar-div">
      <p>
        <span class="tab-front" id="general-tab">商品类型</span>
      </p>
    </div>

    <!-- tab body -->
    <div id="tabbody-div">
      <form enctype="multipart/form-data" action="/admin.php/Admin/Type/add.html" method="POST" name="type_form" >
        <table width="90%" id="general-table" align="center">
          <tr>
            <td class="label">商品类型名称：</td>
            <td><input type="text" name="type_name" value="" style="float:left;color:;" size="30" /></td>
          </tr>
        </table>
...
$.ajax({
  url: '/admin.php/Admin/Type/showattr/type_id/'+_val, // 后台请求地址？ /admin.php/Admin/Type /admin.php/Admin/Type/add
  type: 'GET', // GET方式提交
